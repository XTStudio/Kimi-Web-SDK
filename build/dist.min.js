...
},{"../uikit/helpers/Now":75}],2:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var t=function(e,n){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n])})(e,n)};return function(e,n){function r(){this.constructor=e}t(e,n),e.prototype=null===n?Object.create(n):(r.prototype=n.prototype,new r)}}();Object.defineProperty(exports,"__esModule",{value:!0});var CALayer_1=require("./CALayer"),CAGradientLayer=function(t){function e(){var e=null!==t&&t.apply(this,arguments)||this;return e.defsElement=document.createElementNS("http://www.w3.org/2000/svg","defs"),e.linearGradientElement=document.createElementNS("http://www.w3.org/2000/svg","linearGradient"),e._colors=[],e._locations=[],e._startPoint={x:0,y:0},e._endPoint={x:1,y:0},e}return __extends(e,t),e.prototype.createSVGElement=function(){t.prototype.createSVGElement.call(this),void 0!==this._svgElement&&(this._svgElement.contains(this.defsElement)||(this.linearGradientElement.id="filter."+this._uuid,this.defsElement.appendChild(this.linearGradientElement),this._svgElement.appendChild(this.defsElement))),this._bgElement.setAttribute("fill","url(#filter."+this._uuid+")")},Object.defineProperty(e.prototype,"colors",{get:function(){return this._colors},set:function(t){this._colors=t,this.resetStops()},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"locations",{get:function(){return this._locations},set:function(t){this._locations=t,this.resetStops()},enumerable:!0,configurable:!0}),e.prototype.resetStops=function(){var t=this;this.linearGradientElement.innerHTML="",this.colors.length===this.locations.length&&this.locations.forEach(function(e,n){var r=document.createElementNS("http://www.w3.org/2000/svg","stop");r.setAttribute("offset",(100*e).toFixed(0)+"%"),r.setAttribute("stop-color",t.colors[n].toStyle()),t.linearGradientElement.appendChild(r)})},Object.defineProperty(e.prototype,"startPoint",{get:function(){return this._startPoint},set:function(t){this._startPoint=t,this.linearGradientElement.setAttribute("x1",t.x.toFixed(2)),this.linearGradientElement.setAttribute("y1",t.y.toFixed(2))},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"endPoint",{get:function(){return this._endPoint},set:function(t){this._endPoint=t,this.linearGradientElement.setAttribute("x2",t.x.toFixed(2)),this.linearGradientElement.setAttribute("y2",t.y.toFixed(2))},enumerable:!0,configurable:!0}),e}(CALayer_1.CALayer);exports.CAGradientLayer=CAGradientLayer;
},{"./CALayer":3}],3:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var UIRect_1=require("../uikit/UIRect"),UILabel_1=require("../uikit/UILabel"),CALayer=function(){function e(){this._uuid="calayer."+Math.random()+Math.random(),this._svgElement=void 0,this._clipPathElement=document.createElementNS("http://www.w3.org/2000/svg","clipPath"),this._bgElement=document.createElementNS("http://www.w3.org/2000/svg","rect"),this._contentElement=document.createElementNS("http://www.w3.org/2000/svg","g"),this._borderElement=document.createElementNS("http://www.w3.org/2000/svg","g"),this._view=void 0,this._frame=UIRect_1.UIRectZero,this._hidden=!1,this._cornerRadius=0,this._borderWidth=0,this._borderColor=void 0,this.superlayer=void 0,this.sublayers=[],this._backgroundColor=void 0,this._opacity=1,this._masksToBounds=!1,this._shadowColor=void 0,this._shadowOpacity=0,this._shadowOffset={width:0,height:-3},this._shadowRadius=3}return Object.defineProperty(e.prototype,"view",{get:function(){return this.superlayer?this.superlayer._view:this._view},set:function(e){this._view=e},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"frame",{get:function(){return this._frame},set:function(e){if(this._frame=e,void 0===this._view||void 0!==this._svgElement){this.createSVGElement(),this._svgElement&&(this._svgElement.style.position="absolute",this._svgElement.setAttribute("transform","matrix(1.0, 0.0, 0.0, 1.0, "+e.x.toFixed()+", "+e.y.toFixed()+")"),this._svgElement.setAttribute("width",e.width.toFixed(2)),this._svgElement.setAttribute("height",e.height.toFixed(2))),this._bgElement.setAttribute("width",e.width.toFixed(2)),this._bgElement.setAttribute("height",e.height.toFixed(2)),this._clipPathElement.appendChild(this._bgElement.cloneNode(!0)),this._borderElement.innerHTML="";var t=this._bgElement.cloneNode(!0);t instanceof SVGElement&&(t.style.fillOpacity="0"),this._borderElement.appendChild(t),this._contentElement.setAttribute("width",e.width.toFixed(2)),this._contentElement.setAttribute("height",e.height.toFixed(2))}},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"hidden",{get:function(){return this._hidden},set:function(e){this._hidden=e,this._bgElement.style.display=e?"none":null,this._contentElement.style.display=e?"none":null},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"cornerRadius",{get:function(){return this._cornerRadius},set:function(e){this._cornerRadius=e,void 0!==this._view?this._view.domElement.style.borderRadius=e.toFixed(2)+"px":(this._bgElement.setAttribute("rx",e.toFixed(2)),this._bgElement.setAttribute("ry",e.toFixed(2)))},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"borderWidth",{get:function(){return this._borderWidth},set:function(e){this._borderWidth=e,this.resetBorder()},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"borderColor",{get:function(){return this._borderColor},set:function(e){this._borderColor=e,this.resetBorder()},enumerable:!0,configurable:!0}),e.prototype.resetBorder=function(){if(this.createSVGElement(),void 0===this._svgElement)this.borderWidth>0&&this.borderColor&&this._view&&(this._view.domElement.style.borderWidth=this.borderWidth.toString()+"px",this._view.domElement.style.borderColor=this.borderColor.toStyle(),this._view.domElement.style.borderStyle=this.borderWidth>0?"solid":"unset",this._view.domElement.style.boxSizing=this.borderWidth>0?"border-box":"unset");else if(this.borderWidth>0&&this.borderColor){this._borderElement.style.strokeWidth=this.borderWidth.toFixed(2)+"px",this._borderElement.style.stroke=this.borderColor.toStyle(),this._borderElement.innerHTML="";var e=this._bgElement.cloneNode(!0);e instanceof SVGElement&&(e.style.fillOpacity="0"),this._borderElement.appendChild(e),this._borderElement.style.display=null,this._svgElement.appendChild(this._borderElement),this._view&&(this._view.domElement.style.borderStyle="unset")}else this._borderElement.style.display="none",this._view&&(this._view.domElement.style.borderStyle="unset")},e.prototype.moveBorderElementToFront=function(){void 0!==this._svgElement&&this._svgElement.lastElementChild!==this._borderElement&&(this._svgElement.contains(this._borderElement)&&this._svgElement.removeChild(this._borderElement),this._svgElement.appendChild(this._borderElement))},e.prototype.removeFromSuperlayer=function(){if(this.superlayer){var e=this.superlayer.sublayers.indexOf(this);e>=0&&(this.superlayer.sublayers.splice(e,1),this.superlayer._svgElement&&this._svgElement&&this.superlayer._svgElement.contains(this._svgElement)&&this.superlayer._svgElement.removeChild(this._svgElement)),this.superlayer=void 0}},e.prototype.addSublayer=function(e){void 0!==e.superlayer&&e.removeFromSuperlayer(),this.sublayers.push(e),e.superlayer=this,this.createSVGElement(),e.createSVGElement(),this._svgElement&&e._svgElement&&(this._svgElement.appendChild(e._svgElement),this.moveBorderElementToFront())},e.prototype.createSVGElement=function(){0!=this.sublayers.length&&void 0===this._svgElement&&(void 0!==this._view?(this._svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.backgroundColor=this.backgroundColor,this._svgElement.appendChild(this._bgElement),this._svgElement.appendChild(this._contentElement),this._svgElement&&(this._svgElement.setAttribute("width",this.frame.width.toFixed(2)),this._svgElement.setAttribute("height",this.frame.height.toFixed(2))),0==this._view.domElement.childElementCount?this._view.domElement.appendChild(this._svgElement):this._view.domElement.insertBefore(this._svgElement,this._view.domElement.children[0])):(this._svgElement=document.createElementNS("http://www.w3.org/2000/svg","g"),this.backgroundColor=this.backgroundColor,this._svgElement.appendChild(this._bgElement),this._svgElement.appendChild(this._contentElement)))},Object.defineProperty(e.prototype,"backgroundColor",{get:function(){return this._backgroundColor},set:function(e){this._backgroundColor=e,e?this._bgElement.setAttribute("fill",e.toStyle()):this._bgElement.setAttribute("fill","transparent")},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"opacity",{get:function(){return this._opacity},set:function(e){this._opacity=e,this._bgElement.style.opacity=e.toFixed(2),this._contentElement.style.opacity=e.toFixed(2)},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"masksToBounds",{get:function(){return this._masksToBounds},set:function(e){this._masksToBounds=e,e&&(this.createSVGElement(),this._svgElement&&(this._clipPathElement.id="clip."+this._uuid,this._clipPathElement.innerHTML="",this._clipPathElement.appendChild(this._bgElement.cloneNode(!0)),this._svgElement.appendChild(this._clipPathElement),this._svgElement.setAttribute("clip-path","url(#clip."+this._uuid+")")))},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"shadowColor",{get:function(){return this._shadowColor},set:function(e){this._shadowColor=e,this.resetShadow()},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"shadowOpacity",{get:function(){return this._shadowOpacity},set:function(e){this._shadowOpacity=e,this.resetShadow()},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"shadowOffset",{get:function(){return this._shadowOffset},set:function(e){this._shadowOffset=e,this.resetShadow()},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"shadowRadius",{get:function(){return this._shadowRadius},set:function(e){this._shadowRadius=e,this.resetShadow()},enumerable:!0,configurable:!0}),e.prototype.resetShadow=function(){void 0!==this._view&&(this.shadowOpacity>0&&this.shadowColor&&this.shadowColor.a>0?this._view instanceof UILabel_1.UILabel?this._view.domElement.style.textShadow=this.shadowOffset.width.toString()+"px "+this.shadowOffset.height.toString()+"px "+this.shadowRadius.toString()+"px "+this.shadowColor.colorWithAlphaComponent(this.shadowOpacity).toStyle():this._view.domElement.style.boxShadow=this.shadowOffset.width.toString()+"px "+this.shadowOffset.height.toString()+"px "+this.shadowRadius.toString()+"px "+this.shadowColor.colorWithAlphaComponent(this.shadowOpacity).toStyle():(this._view.domElement.style.textShadow=null,this._view.domElement.style.boxShadow=null))},e}();exports.CALayer=CALayer;
},{"../uikit/UILabel":42,"../uikit/UIRect":53}],4:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var e=function(t,n){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(t,n)};return function(t,n){function i(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}();Object.defineProperty(exports,"__esModule",{value:!0});var CAShapeFillRule,CAShapeLineCap,CAShapeLineJoin,CALayer_1=require("./CALayer");!function(e){e[e.nonZero=0]="nonZero",e[e.evenOdd=1]="evenOdd"}(CAShapeFillRule=exports.CAShapeFillRule||(exports.CAShapeFillRule={})),function(e){e[e.butt=0]="butt",e[e.round=1]="round",e[e.square=2]="square"}(CAShapeLineCap=exports.CAShapeLineCap||(exports.CAShapeLineCap={})),function(e){e[e.miter=0]="miter",e[e.round=1]="round",e[e.bevel=2]="bevel"}(CAShapeLineJoin=exports.CAShapeLineJoin||(exports.CAShapeLineJoin={}));var CAShapeLayer=function(e){function t(){var t=null!==e&&e.apply(this,arguments)||this;return t.pathElement=document.createElementNS("http://www.w3.org/2000/svg","path"),t._path=void 0,t._fillColor=void 0,t._fillRule=CAShapeFillRule.evenOdd,t._lineCap=CAShapeLineCap.butt,t._lineDashPattern=[],t._lineDashPhase=0,t._lineJoin=CAShapeLineJoin.miter,t._lineWidth=0,t._miterLimit=10,t._strokeColor=void 0,t.strokeStart=0,t.strokeEnd=1,t}return __extends(t,e),t.prototype.createSVGElement=function(){e.prototype.createSVGElement.call(this),this._svgElement&&!this._svgElement.contains(this.pathElement)&&this._svgElement.appendChild(this.pathElement)},Object.defineProperty(t.prototype,"path",{get:function(){return this._path},set:function(e){this._path=e,e?this.pathElement.setAttribute("d",e.d3Paths.map(function(e){return e.toString()}).join(" ")):this.pathElement.removeAttribute("d")},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"fillColor",{get:function(){return this._fillColor},set:function(e){this._fillColor=e,this.pathElement.style.fill=e?e.toStyle():"black"},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"fillRule",{get:function(){return this._fillRule},set:function(e){this._fillRule=e,e==CAShapeFillRule.evenOdd?this.pathElement.style.fillRule="evenodd":e==CAShapeFillRule.nonZero&&(this.pathElement.style.fillRule="nonzero")},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"lineCap",{get:function(){return this._lineCap},set:function(e){switch(this._lineCap=e,e){case CAShapeLineCap.butt:this.pathElement.style.strokeLinecap="butt";break;case CAShapeLineCap.round:this.pathElement.style.strokeLinecap="round";break;case CAShapeLineCap.square:this.pathElement.style.strokeLinecap="square"}},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"lineDashPattern",{get:function(){return this._lineDashPattern},set:function(e){this._lineDashPattern=e,this.pathElement.style.strokeDasharray=e.join(" ")},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"lineDashPhase",{get:function(){return this._lineDashPhase},set:function(e){this._lineDashPhase=e,this.pathElement.style.strokeDashoffset=e.toFixed(6)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"lineJoin",{get:function(){return this._lineJoin},set:function(e){switch(this._lineJoin=e,e){case CAShapeLineJoin.miter:this.pathElement.style.strokeLinejoin="miter";break;case CAShapeLineJoin.bevel:this.pathElement.style.strokeLinejoin="bevel";break;case CAShapeLineJoin.round:this.pathElement.style.strokeLinejoin="round"}},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"lineWidth",{get:function(){return this._lineWidth},set:function(e){this._lineWidth=e,this.pathElement.style.strokeWidth=e.toFixed(6)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"miterLimit",{get:function(){return this._miterLimit},set:function(e){this._miterLimit=e,this.pathElement.style.strokeMiterlimit=e.toFixed(6)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"strokeColor",{get:function(){return this._strokeColor},set:function(e){this._strokeColor=e,this.pathElement.style.stroke=e?e.toStyle():null},enumerable:!0,configurable:!0}),t}(CALayer_1.CALayer);exports.CAShapeLayer=CAShapeLayer;
},{"./CALayer":3}],5:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var KIMIDebugger=function(){function KIMIDebugger(e){void 0===e&&(e="127.0.0.1:8090"),this.remoteAddress=e,this.lastTag=void 0,this.closed=!1,this.addConsoleHandler()}return KIMIDebugger.prototype.addConsoleHandler=function(){var e=window.location.href.indexOf("#debug")>0||window.location.href.indexOf("?debug")>0,t=this.remoteAddress;if(e){var n=window.console;["log","info","debug","error","warn"].forEach(function(e){var o=n[e];n[e]=function(){o.apply(this,arguments);for(var n=[],r=0;r<arguments.length;r++)n.push(arguments[r]);var s=new XMLHttpRequest;s.open("POST","http://"+t+"/console",!1),s.send(JSON.stringify({type:e,values:n}))}})}},KIMIDebugger.prototype.connect=function(callback,fallback){var _this=this,debugging=window.location.href.indexOf("#debug")>0||window.location.href.indexOf("?debug")>0;if(!0===debugging){var xmlRequest_1=new XMLHttpRequest;xmlRequest_1.open("POST","http://"+this.remoteAddress+"/source",!1),xmlRequest_1.addEventListener("loadend",function(){var script=xmlRequest_1.responseText;try{eval(script),callback()}catch(e){console.error(e)}_this.fetchUpdate(callback)}),xmlRequest_1.addEventListener("error",function(){void 0!==_this.lastTag&&fallback()}),xmlRequest_1.send()}else fallback()},KIMIDebugger.prototype.fetchUpdate=function(e){var t=this;setTimeout(function(){var n=new XMLHttpRequest;n.open("POST","http://"+t.remoteAddress+"/version",!1),n.addEventListener("loadend",function(){if(!t.closed){var o=n.responseText;void 0!==o&&0!=o.length?void 0===t.lastTag?(t.lastTag=o,t.fetchUpdate(e)):t.lastTag!==o?(t.lastTag=o,t.connect(e,function(){})):t.fetchUpdate(e):t.fetchUpdate(e)}}),n.addEventListener("error",function(){t.fetchUpdate(e)}),n.send()},500)},KIMIDebugger}();exports.KIMIDebugger=KIMIDebugger;
...
"use strict";var __extends=this&&this.__extends||function(){var r=function(t,e){return(r=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,t){r.__proto__=t}||function(r,t){for(var e in t)t.hasOwnProperty(e)&&(r[e]=t[e])})(t,e)};return function(t,e){function n(){this.constructor=t}r(t,e),t.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)}}(),__read=this&&this.__read||function(r,t){var e="function"==typeof Symbol&&r[Symbol.iterator];if(!e)return r;var n,a,o=e.call(r),f=[];try{for(;(void 0===t||t-- >0)&&!(n=o.next()).done;)f.push(n.value)}catch(r){a={error:r}}finally{try{n&&!n.done&&(e=o.return)&&e.call(o)}finally{if(a)throw a.error}}return f},__spread=this&&this.__spread||function(){for(var r=[],t=0;t<arguments.length;t++)r=r.concat(__read(arguments[t]));return r};Object.defineProperty(exports,"__esModule",{value:!0});var Data=function(){function r(t){if(this._arrayBuffer=new ArrayBuffer(0),t instanceof ArrayBuffer)this._arrayBuffer=t.slice(0);else if(void 0!==t)if("string"==typeof t.utf8String){if("function"==typeof TextEncoder)return new r((new TextEncoder).encode(t.utf8String).buffer);for(var e=unescape(encodeURIComponent(t.utf8String)),n=new ArrayBuffer(e.length),a=new Uint8Array(n),o=0,f=e.length;o<f;o++)a[o]=e.charCodeAt(o);this._arrayBuffer=n}else if(t.base64EncodedData instanceof r){var i=(y=window.atob(String.fromCharCode.apply(null,new Uint8Array(t.base64EncodedData._arrayBuffer)))).length,u=new Uint8Array(i);for(o=0;o<i;o++)u[o]=y.charCodeAt(o);this._arrayBuffer=u.buffer}else if("string"==typeof t.base64EncodedString){var y;for(i=(y=window.atob(t.base64EncodedString)).length,u=new Uint8Array(i),o=0;o<i;o++)u[o]=y.charCodeAt(o);this._arrayBuffer=u.buffer}}return r.prototype.arrayBuffer=function(){return this._arrayBuffer},r.prototype.utf8String=function(){return"function"==typeof TextDecoder?(new TextDecoder).decode(this._arrayBuffer):decodeURIComponent(escape(String.fromCharCode.apply(null,new Uint8Array(this._arrayBuffer))))},r.prototype.base64EncodedData=function(){return new r({utf8String:this.base64EncodedString()})},r.prototype.base64EncodedString=function(){return window.btoa(String.fromCharCode.apply(null,new Uint8Array(this._arrayBuffer)))},r.prototype.mutable=function(){return new MutableData(this._arrayBuffer)},r}();exports.Data=Data;var MutableData=function(r){function t(){return null!==r&&r.apply(this,arguments)||this}return __extends(t,r),t.prototype.appendData=function(r){this._arrayBuffer=new Uint8Array(__spread(new Uint8Array(this._arrayBuffer),new Uint8Array(r._arrayBuffer))).buffer},t.prototype.appendArrayBuffer=function(r){this._arrayBuffer=new Uint8Array(__spread(new Uint8Array(this._arrayBuffer),new Uint8Array(r))).buffer},t.prototype.setData=function(r){this._arrayBuffer=r._arrayBuffer.slice(0)},t.prototype.immutable=function(){return new Data(this._arrayBuffer)},t}(Data);exports.MutableData=MutableData;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var Timer=function(){function e(e,t,i){var n=this;this.repeats=i,this.cancelled=!1,this.handler=i?setInterval(function(){!n.cancelled&&t&&t()},1e3*e):setTimeout(function(){!n.cancelled&&t&&t()},1e3*e)}return e.prototype.invalidate=function(){this.cancelled=!0,this.repeats?clearInterval(this.handler):clearTimeout(this.handler)},e}();exports.Timer=Timer;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var UserDefaults=function(){function e(e){void 0===e&&(e=void 0),this.suiteName=e}return e.prototype.valueForKey=function(e){var t=localStorage.getItem(this.buildKey(e));if(void 0!==t&&"string"==typeof t)try{return JSON.parse(t).value}catch(e){}},e.prototype.setValue=function(e,t){void 0===e?localStorage.removeItem(this.buildKey(t)):localStorage.setItem(this.buildKey(t),JSON.stringify({value:e}))},e.prototype.reset=function(){for(var e=0;e<localStorage.length;e++){var t=localStorage.key(e);"string"==typeof t&&0===t.indexOf("com.xt."+(this.suiteName||"standard")+".")&&localStorage.removeItem(t)}},e.prototype.buildKey=function(e){return"com.xt."+(this.suiteName||"standard")+"."+e},e.standard=new e,e}();exports.UserDefaults=UserDefaults;
...
},{"../kimi/EventEmitter":17,"./UIAffineTransform":23,"./UIAnimator":25,"./UIIndexPath":41,"./UIPoint":50,"./UIRect":53,"./UIScrollView":57,"./UISize":58,"./UITouch":69,"./UIView":70}],30:[function(require,module,exports){
...
},{"./UICollectionView":29,"./UIEdgeInsets":34,"./UIIndexPath":41,"./UIRect":53,"./UISize":58}],31:[function(require,module,exports){
...
},{"./UIColor":31,"./UIView":70}],37:[function(require,module,exports){
...
},{"./UIGestureRecognizer":38,"./UITouch":69,"./UIView":70}],44:[function(require,module,exports){
...
},{"../kimi/EventEmitter":17,"./UIAnimator":25,"./UIButton":28,"./UIColor":31,"./UIEnums":35,"./UIFont":37,"./UIImage":39,"./UILabel":42,"./UISize":58,"./UIView":70}],45:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var t=function(i,e){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,i){t.__proto__=i}||function(t,i){for(var e in i)i.hasOwnProperty(e)&&(t[e]=i[e])})(i,e)};return function(i,e){function n(){this.constructor=i}t(i,e),i.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)}}();Object.defineProperty(exports,"__esModule",{value:!0});var UIViewController_1=require("./UIViewController"),UIView_1=require("./UIView"),UINavigationBarViewController=function(t){function i(){var i=null!==t&&t.apply(this,arguments)||this;return i.navigationBarContentHeight=44,i._navigationBarInFront=!0,i.navigationBar=new UIView_1.UIView,i.contentView=new UIView_1.UIView,i.navigationControllerState=void 0,i}return __extends(i,t),Object.defineProperty(i.prototype,"navigationBarInFront",{get:function(){return this._navigationBarInFront},set:function(t){this._navigationBarInFront=t,t?this.view.bringSubviewToFront(this.navigationBar):this.view.bringSubviewToFront(this.contentView)},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"view",{get:function(){return this.contentView},enumerable:!0,configurable:!0}),i.prototype.loadView=function(){t.prototype.loadView.call(this),this.view.addSubview(this.contentView),this.view.addSubview(this.navigationBar)},i.prototype.viewWillAppear=function(i){void 0!==this.navigationController&&void 0===this.navigationControllerState&&(this.navigationControllerState={barHidden:this.navigationController.navigationBar.hidden},this.navigationController.setNavigationBarHidden(!0,i,!1)),t.prototype.viewWillAppear.call(this,i)},i.prototype.viewWillDisappear=function(i){void 0!==this.navigationControllerState&&this.navigationController&&this.navigationController.setNavigationBarHidden(this.navigationControllerState.barHidden,i,!0),t.prototype.viewWillDisappear.call(this,i)},Object.defineProperty(i.prototype,"barFrame",{get:function(){return this.navigationBar.hidden?{x:0,y:0,width:this.view.bounds.width,height:0}:{x:0,y:0,width:this.view.bounds.width,height:this.navigationBarContentHeight}},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"contentFrame",{get:function(){return{x:0,y:this.barFrame.height,width:this.view.bounds.width,height:this.view.bounds.height-this.barFrame.height}},enumerable:!0,configurable:!0}),i.prototype.viewWillLayoutSubviews=function(){this.navigationBar.frame=this.barFrame,this.contentView.frame=this.contentFrame,t.prototype.viewWillLayoutSubviews.call(this)},i}(UIViewController_1.UIViewController);exports.UINavigationBarViewController=UINavigationBarViewController;
},{"./UIView":70,"./UIViewController":71}],46:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var i=function(t,e){return(i=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(i,t){i.__proto__=t}||function(i,t){for(var e in t)t.hasOwnProperty(e)&&(i[e]=t[e])})(t,e)};return function(t,e){function r(){this.constructor=t}i(t,e),t.prototype=null===e?Object.create(e):(r.prototype=e.prototype,new r)}}();Object.defineProperty(exports,"__esModule",{value:!0});var UIViewController_1=require("./UIViewController"),UINavigationBar_1=require("./UINavigationBar"),UIColor_1=require("./UIColor"),UIAnimator_1=require("./UIAnimator"),UINavigationBarViewController_1=require("./UINavigationBarViewController"),UINavigationController=function(i){function t(t){var e=i.call(this)||this;return e.rootViewController=t,e._isUINavigationController=!0,e.navigationBar=new UINavigationBar_1.UINavigationBar,e.beingAnimating=!1,e}return __extends(t,i),t.prototype.viewDidLoad=function(){this.navigationBar.navigationController=this,this.view.backgroundColor=UIColor_1.UIColor.clear,this.view.addSubview(this.navigationBar),this.rootViewController&&this.pushViewController(this.rootViewController,!1),i.prototype.viewDidLoad.call(this)},t.prototype.pushViewController=function(i,t){var e=this;if(void 0===t&&(t=!0),!this.beingAnimating){this.childViewControllers.length>0&&(i.hidesBottomBarWhenPushed=!0),i.hidesBottomBarWhenPushed&&this.tabBarController&&this.tabBarController.view.bringSubviewToFront(this.view),this.addChildViewController(i),this.view.addSubview(i.view),i.view.frame=this.contentFrame(i);var r=this.childViewControllers[this.childViewControllers.length-2],o=this.childViewControllers[this.childViewControllers.length-1];0!=t&&null!=r&&null!=o?(r.viewWillDisappear(!0),o.viewWillAppear(!0),this.beingAnimating=!0,this.doPushAnimation(r,o,function(){r.viewDidDisappear(!0),o.viewDidAppear(!0),e.childViewControllers.forEach(function(i){i!=o&&(i.view.hidden=!0)}),e.beingAnimating=!1}),this.navigationBar.pushNavigationItem(o.navigationItem,!0)):(r&&r.viewWillDisappear(!1),o&&o.viewWillAppear(!1),r&&r.viewDidDisappear(!1),o&&o.viewDidAppear(!1),o&&this.navigationBar.pushNavigationItem(o.navigationItem,!1),this.childViewControllers.forEach(function(i){i!=o&&(i.view.hidden=!0)}))}},t.prototype.popViewController=function(i){var t=this;if(void 0===i&&(i=!0),!this.beingAnimating){var e=this.childViewControllers[this.childViewControllers.length-1],r=this.childViewControllers[this.childViewControllers.length-2];if(void 0!==e&&void 0!==r)return r.view.hidden=!1,e.viewWillDisappear(i),r.viewWillAppear(i),0!=i?(this.beingAnimating=!0,this.doPopAnimation(e,r,function(){e.removeFromParentViewController(),e.view.removeFromSuperview(),e.viewDidDisappear(!0),r.viewDidAppear(!0),r.hidesBottomBarWhenPushed||t.tabBarController&&t.tabBarController.view.bringSubviewToFront(t.tabBarController.tabBar),t.beingAnimating=!1})):(e.removeFromParentViewController(),e.view.removeFromSuperview(),r.view.frame=this.contentFrame(r),e.viewDidDisappear(!0),r.viewDidAppear(!0),r.hidesBottomBarWhenPushed||this.tabBarController&&this.tabBarController.view.bringSubviewToFront(this.tabBarController.tabBar)),this.navigationBar.popNavigationItem(0!=i),e}},t.prototype.popToViewController=function(i,t){var e=this;if(void 0===t&&(t=!0),this.beingAnimating)return[];if(this.childViewControllers.indexOf(i)<0)return[];var r=this.childViewControllers.indexOf(i),o=this.childViewControllers.filter(function(i,t){return t>r});if(0==o.length)return[];var n=i;return n.view.hidden=!1,o.forEach(function(i){i.viewWillDisappear(t)}),n.viewWillAppear(t),0!=t?(this.beingAnimating=!0,this.doPopAnimation(o[o.length-1],n,function(){o.forEach(function(i){i.removeFromParentViewController()}),o.forEach(function(i){i.view.removeFromSuperview()}),o.forEach(function(i){i.viewDidDisappear(!0)}),n.viewDidAppear(!0),n.hidesBottomBarWhenPushed||e.tabBarController&&e.tabBarController.view.bringSubviewToFront(e.tabBarController.tabBar),e.beingAnimating=!1})):(o.forEach(function(i){i.removeFromParentViewController()}),o.forEach(function(i){i.view.removeFromSuperview()}),n.view.frame=this.contentFrame(n),o.forEach(function(i){i.viewDidDisappear(!1)}),n.viewDidAppear(!1),n.hidesBottomBarWhenPushed||this.tabBarController&&this.tabBarController.view.bringSubviewToFront(this.tabBarController.tabBar)),this.navigationBar.popToNavigationItem(n.navigationItem,0!=t),o},t.prototype.popToRootViewController=function(i){void 0===i&&(i=!0);var t=this.childViewControllers[0];return void 0===t?[]:this.popToViewController(t,i)},t.prototype.setViewControllers=function(i,t){var e=this;void 0===t&&(t=!1),this.beingAnimating||(this.childViewControllers.forEach(function(i){i.removeFromParentViewController(),i.view.removeFromSuperview()}),i.forEach(function(i){e.addChildViewController(i),e.view.addSubview(i.view),i.view.frame=e.contentFrame(i)}),this.navigationBar.setItems(i.map(function(i){return i.navigationItem}),0!=t),i[i.length-1]&&1==i[i.length-1].hidesBottomBarWhenPushed?this.tabBarController&&this.tabBarController.view.bringSubviewToFront(this.view):this.tabBarController&&this.tabBarController.view.bringSubviewToFront(this.tabBarController.tabBar))},t.prototype.viewWillLayoutSubviews=function(){var t=this;this.navigationBar.frame=this.barFrame,this.childViewControllers.forEach(function(i){i.view.frame=t.contentFrame(i)}),i.prototype.viewWillLayoutSubviews.call(this)},Object.defineProperty(t.prototype,"barFrame",{get:function(){return this.navigationBar.hidden?{x:0,y:0,width:this.view.bounds.width,height:0}:{x:0,y:0,width:this.view.bounds.width,height:this.navigationBar.barHeight}},enumerable:!0,configurable:!0}),t.prototype.contentFrame=function(i){return i.hidesBottomBarWhenPushed?{x:0,y:this.barFrame.height,width:this.view.bounds.width,height:this.view.bounds.height-this.barFrame.height}:void 0!==this.tabBarController?{x:0,y:this.barFrame.height,width:this.view.bounds.width,height:this.view.bounds.height-this.barFrame.height-this.tabBarController.tabBar.barHeight}:{x:0,y:this.barFrame.height,width:this.view.bounds.width,height:this.view.bounds.height-this.barFrame.height-0}},t.prototype.doPushAnimation=function(i,t,e){var r=this;i.view.frame=this.contentFrame(i);var o=this.contentFrame(t);t.view.frame={x:o.width,y:o.y,width:o.width,height:o.height},UIAnimator_1.UIAnimator.bouncy(0,16,function(){var e=r.contentFrame(i);i.view.frame={x:.25*-e.width,y:e.y,width:e.width,height:e.height},t.view.frame=r.contentFrame(t)},function(){e()})},t.prototype.doPopAnimation=function(i,t,e){var r=this;i instanceof UINavigationBarViewController_1.UINavigationBarViewController?i.view.frame=this.view.bounds:i.view.frame=this.contentFrame(i);var o=this.contentFrame(t);t.view.frame={x:.25*-o.width,y:o.y,width:o.width,height:o.height},UIAnimator_1.UIAnimator.bouncy(0,16,function(){if(i instanceof UINavigationBarViewController_1.UINavigationBarViewController)i.view.frame={x:r.contentFrame(i).width,y:r.view.frame.y,width:r.view.frame.width,height:r.view.frame.height};else{var e=r.contentFrame(i);i.view.frame={x:e.width,y:e.y,width:e.width,height:e.height}}t.view.frame=r.contentFrame(t)},function(){e()})},t.prototype.didAddSubview=function(t){this.view.bringSubviewToFront(this.navigationBar),i.prototype.didAddSubview.call(this,t)},t.prototype.setNavigationBarHidden=function(i,t,e){var r=this;void 0===e&&(e=!1),t?(e&&(this.navigationBar.hidden=i,this.navigationBar.alpha=i?1:0),UIAnimator_1.UIAnimator.curve(.25,function(){e?r.navigationBar.alpha=i?0:1:r.navigationBar.hidden=i},void 0)):this.navigationBar.hidden=i;var o=this.childViewControllers[this.childViewControllers.length-1];o instanceof UINavigationBarViewController_1.UINavigationBarViewController&&o.navigationControllerState&&(o.navigationControllerState.barHidden=i)},t}(UIViewController_1.UIViewController);exports.UINavigationController=UINavigationController;
},{"./UIAnimator":25,"./UIColor":31,"./UINavigationBar":44,"./UINavigationBarViewController":45,"./UIViewController":71}],47:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var t=function(e,i){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i])})(e,i)};return function(e,i){function s(){this.constructor=e}t(e,i),e.prototype=null===i?Object.create(i):(s.prototype=i.prototype,new s)}}();Object.defineProperty(exports,"__esModule",{value:!0});var UIViewController_1=require("./UIViewController"),UIScrollView_1=require("./UIScrollView"),UIPoint_1=require("./UIPoint"),UIPageViewController=function(t){function e(e){void 0===e&&(e=!1);var i=t.call(this)||this;return i.isVertical=e,i.loops=!1,i._pageItems=void 0,i._currentPage=void 0,i.scrollView=(new UIScrollView_1.UIScrollView).on("didEndDecelerating",function(){i.changeContents()}).on("didEndScrollingAnimation",function(){i.changeContents()}),i}return __extends(e,t),Object.defineProperty(e.prototype,"pageItems",{get:function(){return this._pageItems},set:function(t){this._pageItems=t,t&&t.length>0&&(this.currentPage=t[0],this.resetContents())},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"currentPage",{get:function(){return this._currentPage},set:function(t){this._currentPage&&this._currentPage.removeFromParentViewController(),this._currentPage=t,t&&t.parentViewController!=this&&this.addChildViewController(t),this.resetContents()},enumerable:!0,configurable:!0}),e.prototype.scrollToNextPage=function(t){void 0===t&&(t=!0),1==this.isVertical?this.scrollView.contentInset.bottom>0&&(this.scrollView.setContentOffset({x:0,y:this.scrollView.contentInset.bottom},t),0==t&&this.changeContents()):this.scrollView.contentInset.right>0&&(this.scrollView.setContentOffset({x:this.scrollView.contentInset.right,y:0},t),0==t&&this.changeContents())},e.prototype.scrollToPreviousPage=function(t){void 0===t&&(t=!0),1==this.isVertical?this.scrollView.contentInset.top>0&&(this.scrollView.setContentOffset({x:0,y:-this.scrollView.contentInset.top},t),0==t&&this.changeContents()):this.scrollView.contentInset.left>0&&(this.scrollView.setContentOffset({x:-this.scrollView.contentInset.left,y:0},t),0==t&&this.changeContents())},e.prototype.beforeViewController=function(t){if(void 0!==this.pageItems){var e=this.pageItems.indexOf(t);if(!(e>=0))return;if(e>0)return this.pageItems[e-1];if(this.loops&&this.pageItems.length>1)return this.pageItems[this.pageItems.length-1]}return this.val("beforeViewController",t)},e.prototype.afterViewController=function(t){if(void 0!==this.pageItems){var e=this.pageItems.indexOf(t);if(!(e>=0))return;if(e+1<this.pageItems.length)return this.pageItems[e+1];if(this.loops&&this.pageItems.length>1)return this.pageItems[0]}return this.val("afterViewController",t)},e.prototype.didFinishAnimating=function(t,e){this.emit("didFinishAnimating",t,e)},e.prototype.viewDidLoad=function(){this.scrollView.pagingEnabled=!0,this.scrollView.bounces=!1,this.scrollView.showsHorizontalScrollIndicator=!1,this.scrollView.showsVerticalScrollIndicator=!1,this.view.addSubview(this.scrollView),t.prototype.viewDidLoad.call(this)},e.prototype.viewWillLayoutSubviews=function(){this.scrollView.frame=this.view.bounds,this.scrollView.contentSize={width:this.view.bounds.width,height:this.view.bounds.height},this.resetContents(),t.prototype.viewWillLayoutSubviews.call(this)},e.prototype.changeContents=function(){if(1==this.isVertical){if(Math.abs(this.scrollView.contentOffset.y- -this.scrollView.bounds.height)<4){if(void 0===(e=this.currentPage))return;if(void 0===(t=this.beforeViewController(e)))return;this.currentPage=t,this.resetContents(),this.didFinishAnimating(t,e)}else if(Math.abs(this.scrollView.contentOffset.y-this.scrollView.bounds.height)<4){if(void 0===(e=this.currentPage))return;if(void 0===(i=this.afterViewController(e)))return;this.currentPage=i,this.resetContents(),this.didFinishAnimating(i,e)}}else if(Math.abs(this.scrollView.contentOffset.x- -this.scrollView.bounds.width)<4){var t;if(void 0===(e=this.currentPage))return;if(void 0===(t=this.beforeViewController(e)))return;this.currentPage=t,this.resetContents(),this.didFinishAnimating(t,e)}else if(Math.abs(this.scrollView.contentOffset.x-this.scrollView.bounds.width)<4){var e,i;if(void 0===(e=this.currentPage))return;if(void 0===(i=this.afterViewController(e)))return;this.currentPage=i,this.resetContents(),this.didFinishAnimating(i,e)}},e.prototype.resetContents=function(){var t=this.currentPage;if(void 0!==t){var e=this.beforeViewController(t),i=this.afterViewController(t);this.scrollView.subviews.forEach(function(s){s==t.view||void 0!==e&&s==e.view||void 0!==i&&s==i.view||s.removeFromSuperview()}),t.view.frame=this.view.bounds,this.scrollView.addSubview(t.view),e&&(this.scrollView.addSubview(e.view),1==this.isVertical?e.view.frame={x:0,y:-this.view.bounds.height,width:this.view.bounds.width,height:this.view.bounds.height}:e.view.frame={x:-this.view.bounds.width,y:0,width:this.view.bounds.width,height:this.view.bounds.height}),i&&(this.scrollView.addSubview(i.view),1==this.isVertical?i.view.frame={x:0,y:this.view.bounds.height,width:this.view.bounds.width,height:this.view.bounds.height}:i.view.frame={x:this.view.bounds.width,y:0,width:this.view.bounds.width,height:this.view.bounds.height}),1==this.isVertical?this.scrollView.contentInset={top:void 0!==e?Math.ceil(this.view.bounds.height):0,left:0,bottom:void 0!==i?Math.ceil(this.view.bounds.height):0,right:0}:this.scrollView.contentInset={top:0,left:void 0!==e?Math.ceil(this.view.bounds.width):0,bottom:0,right:void 0!==i?Math.ceil(this.view.bounds.width):0},this.scrollView.contentOffset=UIPoint_1.UIPointZero}},e}(UIViewController_1.UIViewController);exports.UIPageViewController=UIPageViewController;
},{"./UIPoint":50,"./UIScrollView":57,"./UIViewController":71}],48:[function(require,module,exports){
...
},{"./UIGestureRecognizer":38,"./UITouch":69,"./UIView":70}],49:[function(require,module,exports){
...
},{"./UIAnimator":25,"./UIView":70}],52:[function(require,module,exports){
...
},{"./UIColor":31,"./UIView":70}],55:[function(require,module,exports){
...
},{"./UIGestureRecognizer":38}],56:[function(require,module,exports){
...
},{"./UIAnimator":25,"./UIColor":31,"./UIEdgeInsets":34,"./UIFetchMoreControl":36,"./UIPanGestureRecognizer":48,"./UIPoint":50,"./UIRefreshControl":54,"./UISize":58,"./UIView":70,"./helpers/Scroller":76}],58:[function(require,module,exports){
...
},{"./UIAnimator":25,"./UILongPressGestureRecognizer":43,"./UIView":70}],60:[function(require,module,exports){
...
},{"./UIEnums":35,"./UIView":70}],61:[function(require,module,exports){
...
},{"./UIEdgeInsets":34}],65:[function(require,module,exports){
...
},{"./UIAnimator":25,"./UIColor":31,"./UIEdgeInsets":34,"./UIIndexPath":41,"./UIRect":53,"./UIScrollView":57,"./UITouch":69,"./UIView":70}],66:[function(require,module,exports){
...
},{"./UIGestureRecognizer":38,"./UITouch":69,"./UIView":70}],67:[function(require,module,exports){
...
},{"./UIButton":28,"./UIColor":31,"./UIEnums":35,"./UIImage":39,"./UILabel":42,"./UIView":70}],68:[function(require,module,exports){
...
},{"./UIColor":31,"./UIEnums":35,"./UIView":70}],69:[function(require,module,exports){
...
},{"./Bezier":72}],74:[function(require,module,exports){
