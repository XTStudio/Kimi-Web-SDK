...
},{"../uikit/helpers/Now":68}],2:[function(require,module,exports){
...
},{"../uikit/UIRect":46}],4:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var URLRequest_1=require("./URLRequest"),URL_1=require("./URL"),Data_1=require("./Data"),URLResponse_1=require("./URLResponse"),URLSession=function(){function e(){}return e.prototype.dataTask=function(e,t){if(e instanceof URLRequest_1.URLRequest)return new URLSessionTask(e,t);if(e instanceof URL_1.URL)return new URLSessionTask(new URLRequest_1.URLRequest(e),t);var s=URL_1.URL.URLWithString(e);if(void 0!==s)return new URLSessionTask(new URLRequest_1.URLRequest(s),t);throw Error("invalid url.")},e.shared=new e,e}();exports.URLSession=URLSession;var URLSessionTask=function(){function e(e,t){this.request=e,this.complete=t,this._xmlRequest=void 0}return e.prototype.resume=function(){var e=this,t=new XMLHttpRequest;if(t.timeout=1e3*this.request.timeout,t.responseType="arraybuffer",t.open(this.request.HTTPMethod||"GET",this.request.URL.absoluteString,!0),this.request.allHTTPHeaderFields)for(var s in this.request.allHTTPHeaderFields)this.request.allHTTPHeaderFields.hasOwnProperty(s)&&t.setRequestHeader(s,this.request.allHTTPHeaderFields[s]);t.addEventListener("loadend",function(){var s,n,r=t.response instanceof ArrayBuffer?new Data_1.Data(t.response):void 0,i=new URLResponse_1.URLResponse;i.URL=e.request.URL,i.expectedContentLength=parseInt(t.getResponseHeader("Content-Type")||"0"),isNaN(i.expectedContentLength)&&(i.expectedContentLength=0),i.MIMEType=(s=t.getResponseHeader("Content-Type")||"").indexOf(";")>=0?s.split(";")[0].trim():s.trim(),i.textEncodingName=function(){var e=t.getResponseHeader("Content-Type")||"";return e.indexOf("charset=")>=0?e.split("charset=").pop().trim():"UTF-8"}(),i.statusCode=t.status,i.allHeaderFields=(n={},t.getAllResponseHeaders().split("\n").forEach(function(e){var t=e.indexOf(": ");if(t>=0){var s=e.substring(0,t).replace(/\b[a-z]/g,function(e){return e.toUpperCase()}).trim(),r=e.substring(t+2).trim();n[s]=r}}),n),e.complete(r,i,void 0)}),t.addEventListener("error",function(s,n){var r=t.response instanceof ArrayBuffer?new Data_1.Data(t.response):void 0,i=new URLResponse_1.URLResponse;i.URL=e.request.URL,i.statusCode=t.status,e.complete(r,i,n.error)}),this.request.HTTPBody instanceof Data_1.Data?t.send(this.request.HTTPBody._arrayBuffer):t.send(),this._xmlRequest=t},e.prototype.cancel=function(){this._xmlRequest&&this._xmlRequest.abort()},e}();exports.URLSessionTask=URLSessionTask;
...
},{"./EventEmitterImp":13}],13:[function(require,module,exports){
...
},{"../foundation/DispatchQueue":6,"./UIAnimator":19,"./UIAttributedString":20,"./UIButton":22,"./UIColor":25,"./UIEnums":28,"./UIFont":30,"./UILabel":35,"./UIScreen":49,"./UITapGestureRecognizer":59,"./UIView":63,"./UIViewController":64}],16:[function(require,module,exports){
...
},{"./UIView":63}],17:[function(require,module,exports){
...
},{"./helpers/LinearAnimator":66,"./helpers/rebound.min":72}],20:[function(require,module,exports){
...
},{"./UIColor":25,"./UIEnums":28,"./UIFont":30,"./helpers/TextMeasurer":70}],21:[function(require,module,exports){
...
},{"./helpers/d3-path.min":71}],22:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UIColor":25,"./UIEdgeInsets":27,"./UIEnums":28,"./UIFont":30,"./UIImageView":33,"./UILabel":35,"./UILongPressGestureRecognizer":36,"./UISize":51,"./UITapGestureRecognizer":59,"./UIView":63}],23:[function(require,module,exports){
...
},{"../kimi/EventEmitter":12,"./UIAffineTransform":17,"./UIAnimator":19,"./UIIndexPath":34,"./UIPoint":43,"./UIRect":46,"./UIScrollView":50,"./UISize":51,"./UITouch":62,"./UIView":63}],24:[function(require,module,exports){
...
},{"./UICollectionView":23,"./UIEdgeInsets":27,"./UIIndexPath":34,"./UIRect":46,"./UISize":51}],25:[function(require,module,exports){
...
},{"./UIColor":25,"./UIView":63}],30:[function(require,module,exports){
...
},{"../kimi/EventEmitter":12,"./UIPoint":43}],32:[function(require,module,exports){
...
},{"../kimi/EventEmitter":12,"./UISize":51}],33:[function(require,module,exports){
...
},{"./UIEnums":28,"./UIImage":32,"./UISize":51,"./UIView":63,"./helpers/Now":68}],34:[function(require,module,exports){
...
},{"./UIColor":25,"./UIEnums":28,"./UIFont":30,"./UIView":63,"./helpers/TextMeasurer":70}],36:[function(require,module,exports){
...
},{"./UIGestureRecognizer":31,"./UITouch":62,"./UIView":63}],37:[function(require,module,exports){
...
},{"../kimi/EventEmitter":12,"./UIAnimator":19,"./UIButton":22,"./UIColor":25,"./UIEnums":28,"./UIFont":30,"./UIImage":32,"./UILabel":35,"./UISize":51,"./UIView":63}],38:[function(require,module,exports){
...
},{"./UIView":63,"./UIViewController":64}],39:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UIColor":25,"./UINavigationBar":37,"./UINavigationBarViewController":38,"./UIViewController":64}],40:[function(require,module,exports){
...
},{"./UIPoint":43,"./UIScrollView":50,"./UIViewController":64}],41:[function(require,module,exports){
...
},{"./UIGestureRecognizer":31,"./UITouch":62,"./UIView":63}],42:[function(require,module,exports){
...
},{"./UIGestureRecognizer":31}],43:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UIView":63}],45:[function(require,module,exports){
...
},{"./UIColor":25,"./UIView":63}],48:[function(require,module,exports){
...
},{"./UIGestureRecognizer":31}],49:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UIColor":25,"./UIEdgeInsets":27,"./UIFetchMoreControl":29,"./UIPanGestureRecognizer":41,"./UIPoint":43,"./UIRefreshControl":47,"./UISize":51,"./UIView":63,"./helpers/Scroller":69}],51:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UILongPressGestureRecognizer":36,"./UIView":63}],53:[function(require,module,exports){
...
},{"./UIEnums":28,"./UIView":63}],54:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UIColor":25,"./UILongPressGestureRecognizer":36,"./UIView":63}],55:[function(require,module,exports){
...
},{"./UIColor":25,"./UIEdgeInsets":27,"./UIEnums":28,"./UIFont":30,"./UIImageView":33,"./UILabel":35,"./UISize":51,"./UITapGestureRecognizer":59,"./UIView":63}],56:[function(require,module,exports){
...
},{"./UITabBar":55,"./UIViewController":64}],57:[function(require,module,exports){
...
},{"./UIEdgeInsets":27}],58:[function(require,module,exports){
...
},{"./UIAnimator":19,"./UIColor":25,"./UIEdgeInsets":27,"./UIIndexPath":34,"./UIRect":46,"./UIScrollView":50,"./UITouch":62,"./UIView":63}],59:[function(require,module,exports){
...
},{"./UIGestureRecognizer":31,"./UITouch":62,"./UIView":63}],60:[function(require,module,exports){
...
},{"./UIButton":22,"./UIColor":25,"./UIEnums":28,"./UIImage":32,"./UILabel":35,"./UIView":63}],61:[function(require,module,exports){
...
},{"./UIColor":25,"./UIEnums":28,"./UIView":63}],62:[function(require,module,exports){
...
},{"./UIPoint":43}],63:[function(require,module,exports){
...
},{"../coregraphics/CALayer":3,"../kimi/EventEmitter":12,"./UIAffineTransform":17,"./UIAnimator":19,"./UIColor":25,"./UIEdgeInsets":27,"./UIEnums":28,"./UIRect":46,"./UITouch":62,"./helpers/Matrix":67}],64:[function(require,module,exports){
...
},{"../kimi/EventEmitter":12,"./UIColor":25,"./UINavigationBar":37,"./UITabBarItem":57,"./UIView":63}],65:[function(require,module,exports){
...
},{"./Bezier":65}],67:[function(require,module,exports){
...
},{"./Now":68}],70:[function(require,module,exports){
