...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var UserDefaults=function(){function t(t){void 0===t&&(t=void 0),this.suiteName=t}return t.prototype.dump=function(){var t="com.xt."+(this.suiteName||"standard")+".",e=[];for(var o in localStorage)0===o.indexOf(t)&&e.push(o);var r={};return e.forEach(function(t){r[t]=localStorage.getItem(t)}),r},t.prototype.valueForKey=function(t){var e=localStorage.getItem(this.buildKey(t));if(void 0!==e&&"string"==typeof e)try{return JSON.parse(e).value}catch(t){}},t.prototype.setValue=function(t,e){void 0===t?localStorage.removeItem(this.buildKey(e)):localStorage.setItem(this.buildKey(e),JSON.stringify({value:t}))},t.prototype.reset=function(){for(var t=0;t<localStorage.length;t++){var e=localStorage.key(t);"string"==typeof e&&0===e.indexOf("com.xt."+(this.suiteName||"standard")+".")&&localStorage.removeItem(e)}},t.prototype.buildKey=function(t){return"com.xt."+(this.suiteName||"standard")+"."+t},t.standard=new t,t}();exports.UserDefaults=UserDefaults;
