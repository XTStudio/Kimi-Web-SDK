...
},{"./helpers/LinearAnimator":76,"./helpers/rebound.min":83}],26:[function(require,module,exports){
...
},{"./UIColor":31,"./UIEnums":35,"./UIFont":37,"./helpers/TextMeasurer":81}],27:[function(require,module,exports){
...
},{"./helpers/d3-path.min":82}],28:[function(require,module,exports){
...
},{"./UIColor":31,"./UIEnums":35,"./UIFont":37,"./UIView":71,"./helpers/TextMeasurer":81}],43:[function(require,module,exports){
...
},{"./UIAnimator":25,"./UIColor":31,"./UINavigationBar":44,"./UINavigationBarViewController":45,"./UIViewController":72,"./helpers/Router":79}],47:[function(require,module,exports){
...
},{"./UIAnimator":25,"./UIColor":31,"./UIEdgeInsets":34,"./UIFetchMoreControl":36,"./UIPanGestureRecognizer":48,"./UIPoint":50,"./UIRefreshControl":55,"./UISize":59,"./UIView":71,"./helpers/IdelQueue":75,"./helpers/Scroller":80}],59:[function(require,module,exports){
...
},{"../coregraphics/CALayer":3,"../kimi/EventEmitter":17,"./UIAffineTransform":23,"./UIAnimator":25,"./UIColor":31,"./UIEdgeInsets":34,"./UIEnums":35,"./UIRect":54,"./UITouch":70,"./helpers/Matrix":77,"./helpers/Router":79}],72:[function(require,module,exports){
...
},{"../kimi/EventEmitter":17,"./UIColor":31,"./UIEdgeInsets":34,"./UINavigationBar":44,"./UITabBarItem":65,"./UIView":71,"./helpers/Router":79}],73:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var Router=function(){function t(){this.routes={},this.locked=!1}return t.prototype.addListenter=function(){var t=this;"#"!==window.location.hash&&""!==window.location.hash&&(window.location.hash=""),window.addEventListener("hashchange",function(o){if(t.locked)t.locked=!1;else{var e=o.oldURL.split("#")[1];void 0!==t.routes[e]&&(t.routes[e](),delete t.routes[e])}})},t.prototype.addRoute=function(t,o){var e=this.createHash();t.__hash=e,this.routes[e]=o,this.locked=!0,window.location.hash=e},t.prototype.popToRoute=function(t){t.__hash&&(window.location.hash=t.__hash)},t.prototype.createHash=function(){return"xt_router_"+Math.floor(65536*(1+Math.random())).toString(16).substring(1)+"_"+Math.floor(65536*(1+Math.random())).toString(16).substring(1)+"_"+Math.floor(65536*(1+Math.random())).toString(16).substring(1)+"_"+Math.floor(65536*(1+Math.random())).toString(16).substring(1)},t.shared=new t,t}();exports.Router=Router;
...
},{"./Now":78}],81:[function(require,module,exports){
...
},{"../UIRect":54}],82:[function(require,module,exports){
